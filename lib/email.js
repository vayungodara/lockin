...
function generateReminderEmailHtml({ pactTitle, deadline, userName }) {
  // Format deadline explicitly in UTC so all recipients see a consistent,
  // unambiguous timestamp regardless of server or client locale, and append
  // " (UTC)" so the label is clear.
          ...
          <tr>
            <td style="padding: 32px 24px;">
              <p style="margin: 0 0 24px 0; color: #5E6168; font-size: 16px; line-height: 1.5;">
                Hey${userName ? ` ${escapeHtml(userName)}` : ''},
              </p>
