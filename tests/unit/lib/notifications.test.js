...
describe('getNotifications', () => {
  it('returns notifications on success', async () => {
    ...
    const rows = [
      { id: 'n-1', type: 'pact_reminder', title: 'Reminder', message: 'Do it', is_read: false, created_at: '2024-06-15T12:00:00Z' },
      { id: 'n-2', type: 'streak_milestone', title: '7 days!', message: 'Keep going', is_read: true, created_at: '2024-06-14T12:00:00Z' },
    ];
