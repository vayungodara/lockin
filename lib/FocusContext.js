...
export function FocusProvider({ children }) {
  ...
  // Keep ref in sync with latest callback synchronously during render so
  // the interval never fires against a stale or null ref. A useEffect here
  // would be redundant — the synchronous assignment already runs after
  // every re-render (which happens whenever handleTimerComplete changes).
