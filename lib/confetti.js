...
/**
 * Portal wrapper — renders confetti at document.body level so it escapes
 * any parent overflow:hidden or CSS transforms from Framer Motion.
 */
function ConfettiPortal({ particles }) {
  ...
  return createPortal(<ConfettiExplosion particles={particles} />, document.body);
}
...
export function useConfetti() {
  ...
  const ConfettiComponent = <ConfettiPortal particles={particles} />;

  return { fire, ConfettiComponent };
}

// Legacy named exports — no-ops, use useConfetti() hook instead.
